...
/// Ported from DriveVerse `Core/Lyrics/LRCParser.swift` (MIT © 2026 Praveet
/// Gupta, see THIRD_PARTY_NOTICES.md). The standard LRC dialect complements
/// Caraoke's own TSV fixture format: licensed lyric providers and user
/// imports both speak LRC.
