...
/// Ported from DriveVerse `LiveActivityUpdateThrottle` (MIT © 2026 Praveet
/// Gupta, see THIRD_PARTY_NOTICES.md), renamed for Caraoke.
///
...
/// Critical changes (track change, play/pause flip) always send now.
/// Pure value type so the spacing rules are unit-testable without ActivityKit.
struct ActivityUpdateThrottle {
