...
// Ported from DriveVerse `Core/NowPlaying/NowPlayingCoordinator.swift`
// (MIT © 2026 Praveet Gupta, see THIRD_PARTY_NOTICES.md), renamed to
// Caraoke's source pin vocabulary.
...
/// Pure arbitration: Apple Music playing wins (local, exact position) →
/// Spotify playing → otherwise keep the last known track, marked not playing.
